...
require("lazy").setup({
  spec = {
    ...
    -- { import = "lazyvim.plugins.extras.lang.java" }, -- Java (Requiere JDK instalado)

    -- === SCRIPTING / WEB ===
    { import = "lazyvim.plugins.extras.lang.python" }, -- Python
    { import = "lazyvim.plugins.extras.lang.typescript" }, -- JS/TS/React
    -- { import = "lazyvim.plugins.extras.lang.php" }, -- PHP
    ...
    { import = "lazyvim.plugins.extras.lang.docker" }, -- Dockerfiles
    { import = "lazyvim.plugins.extras.lang.markdown" }, -- Markdown avanzado
    { import = "lazyvim.plugins.extras.lang.sql" }, -- Bases de datos
